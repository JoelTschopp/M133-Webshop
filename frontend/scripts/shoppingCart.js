...
async function loadPage() {
    ...
    if (cart) {   
        let table = "<table id=\"cartTable\" class=\"table\"><tbody id=\"cart_table_body\"><tr><th>Produkt</th><th>Einzelpreis</th><th>Anzahl</th><th>Total</th></tr></tbody></table>";
        ...
        for (let i = 0; i < shoppingCart.length; i++) {
            ...
            html += "<tr><td>"+title+"</td><td>CHF "+price+"</td><td><button onclick=\"subtractItem("+i+")\">-</button><a> "+amount+" </a><button onclick=\"addItem("+i+")\">+</button></td><td>CHF "+total+"</td></tr>";
        }
